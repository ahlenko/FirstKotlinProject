...
class UsersListActivity : AppCompatActivity() {
    val LINK_URL : String = "http://jsonplaceholder.typicode.com/users"
    val IMAGE_URL : String = "https://quizee.app/storage/avatars/"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userPrintThread : Thread = Thread {
            ...
            runOnUiThread(Runnable {
                if (!userList.isEmpty()){
                    ...
                    binding.UserNotInListTitle?.text = "Список порожній"
                }
            })
        }
        ...
        if (!isInternetAvailable(this)){
            if (dasCashed.isCashed()){
                ...
                Toast.makeText(this, "Помилка підключення до інтернету", Toast.LENGTH_SHORT).show()
            }
            ...
            Toast.makeText(this, "Помилка, Інтернет підключення відсутнє", Toast.LENGTH_SHORT).show()
        }
    }
